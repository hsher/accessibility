                  ...
                  <main>
                    <section>
                      ...
                      <p className="Typography Typography--body2 u-pb-10">
                        ...
                        Для тех, у кого отсутствует зрение есть "скрин ридеры" - программы или плагины для озвучивания контента на странице, например, ChromeVox Classic Extension.<br/>
                      ...
                      <p className="Typography Typography--body2 u-pb-10">
                        ...
                        Для навигации использовать тег <code class="u-noWrap">{"<nav>"}</code>, для списков <code class="u-noWrap">{"<ul>"}</code> и <code class="u-noWrap">{"<ol>"}</code>, пусть таблица будет <code class="u-noWrap">{"<table>"}</code>, а заголовок - <code class="u-noWrap">{"<h1>"}</code>, <code class="u-noWrap">{"<h2>"}</code>...".<br/>
                    ...
                    <section>
                      <h2 className="Typography Typography--heading2 u-pb-20">Пример списка сотрудников</h2>

                      <p className="Typography Typography--body2 u-pb-30">
                        Пример списка изображений с подписями. Часто подобную конструкцию можно встретить в списке сотрудников компании, так же похожая конструкция характерна для товаров интернет-магазина. Со стороны верстки - это самый обычный <code class="u-noWrap">{"<ul>"}</code> список. Затруднения могут возникнуть с альтернативным текстом для изображения. В данном случае, поскольку под самим изображением идет описание "сотрудника" (его имя и должность) - то в разметке страницы вместо {"alt"} текста картинки использовалась ссылка на описание (<code class="u-noWrap">{"aria-labelledby"}</code>). В таком случае, когда скрин ридер сфокусируется на элементе списка - он просто "прочитает" имя и должность. Подробнее про <code class="u-noWrap">{"alt"}</code> тексты можно прочитать: <a href="https://webaim.org/techniques/alttext/">alttext</a>
                      </p>
                ...
                <div className="col-lg-3 d-none d-lg-block">
                  <aside className="u-sticky u-pt-10">
                    ...
                    <span className="Typography Typography--body1">
                      ...
                      Основной контент мы заварачиваем в <code class="u-noWrap">{"<main>"}</code> тэг, а подобные огрызки в <code class="u-noWrap">{"<aside>"}</code>.
                    </span>
                  </aside>
                </div>
              </div>
